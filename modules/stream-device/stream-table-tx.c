...
struct ra_stream_table_tx_fpga {
	...
	__be32 destination_ip_primary;		/* 0x08 */
	__be32 destination_ip_secondary;	/* 0x0c */
	...
	__be16 vlan_tag_primary;		/* 0x1e */
	__be16 vlan_tag_secondary;		/* 0x1c */

	__u16 ip_total_len;			/* 0x22 */
	__u8 dscp_tos;				/* 0x21 */
	__u8 ttl;				/* 0x20 */

	__be32 source_ip_primary;		/* 0x24 */
	__be32 source_ip_secondary;		/* 0x28 */

	__be16 destination_port_primary;	/* 0x2e */
	__be16 source_port_primary;		/* 0x2c */
	__be16 destination_port_secondary;	/* 0x32 */
	__be16 source_port_secondary;		/* 0x30 */
			     ...
			     struct ra_stream_table_tx *sttb)
{
	...
	dev_info(dev, "Ravenna stream table TX, %d entries",
		 sttb->max_entries);
