...
#define RA_NET_LINK_SPEED_STATUS		0x0010
#define RA_NET_LINK_SPEED_STATUS_UP		BIT(0)
#define RA_NET_LINK_SPEED_STATUS_SPEED_MASK	(3U << 1)
#define RA_NET_LINK_SPEED_STATUS_SPEED_10	(0U << 1)
#define RA_NET_LINK_SPEED_STATUS_SPEED_100	(1U << 1)
#define RA_NET_LINK_SPEED_STATUS_SPEED_1000	(2U << 1)
#define RA_NET_LINK_SPEED_STATUS_FULL_DUPLEX	BIT(3)
